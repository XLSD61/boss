...
public class DualRugControl : MonoBehaviour
{
    ...
    public float dualRugTime;//  silah atış aralığı
    ...
    public Animator dualRug; //  animasyon
    private void Start()
    {
    ...
    void Update()
    {
        ...
        {
            fireTime = Time.time + dualRugTime;
            //------1.Namlu
            ...
            //-----------------Animations-------------------------------
            dualRug.SetTrigger("dualrugshot");
        }
    }
}
